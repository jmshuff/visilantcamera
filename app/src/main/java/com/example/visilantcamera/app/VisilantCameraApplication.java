package com.example.visilantcamera.app;
...
public class VisilantCameraApplication extends MultiDexApplication implements Application.ActivityLifecycleCallbacks{

    private static final String TAG = VisilantCameraApplication.class.getSimpleName();
